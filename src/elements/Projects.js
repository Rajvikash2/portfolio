...
export const Projects = () => {
  return (
    ...
    <div className='border p-5 rounded-lg max-w-sm cursor-pointer flex flex-col gap-4'>
       ...
       <img className=' object-cover w-full' src={expense}width={220} alt='project'/>
       </div>
       ...
       <div className='border p-5 rounded-lg max-w-sm cursor-pointer flex flex-col gap-4'>
         <div className='flex justify-center w-full'> <img className=' object-cover w-full' src={blog} width={220} alt='project' /></div>            
        <h2 className='font-bold'>Simple blog page:</h2>
        <p className='text-gray-400'>A responsive blog page created using react</p>
       </div>
       <div className='border p-5 rounded-lg max-w-sm cursor-pointer flex flex-col gap-4'>
         <div className='flex justify-center w-full'><img className=' object-cover w-full' src={pas} width={220} alt='project' /></div>
       ...
       <div className='border p-5 rounded-lg max-w-sm cursor-pointer flex flex-col gap-4'>
         <div className='flex justify-center w-full'><img className=' object-cover w-full' src={tm} width={220} alt='profile' /></div>
       ...
       <div className='border p-5 rounded-lg max-w-sm cursor-pointer flex flex-col gap-4'>
         <div className='flex justify-center w-full'><img className=' object-cover w-full' src={sp} width={220} alt='project' /></div>
       ...
       <div className='border p-5 rounded-lg max-w-sm max-h-96 cursor-pointer flex flex-col gap-4'>
         <div className='flex justify-center '><img className=' object-cover w-full' src={gvm} width={220} alt='profile' /></div>
