  ...
  return (
    <div className='w-full md:w-[90%] mx-auto px-10 py-10'>
      ...
      <div className='w-[90%] text-xl text-gray-300 mt-5 flex flex-row max-sm:flex-col gap-5 justify-around'>
        <div data-aos="zoom-in-right" className='bg-black p-4 rounded-xl border-4 border-gray-700'>
          <ul>
        ...
        <div data-aos="zoom-in-left" className='bg-black p-4 rounded-xl border-4 border-gray-700'>
          <ul>
      ...
      <div data-aos="zoom-in-up" data-aos-duration="500" className='text-gray-200 bg-black  p-2 md:p-5 mt-10 text-2xl'>
        <h2>
        ...
        <div className='p-10 mt-8 shadow-md rounded-lg'>
          <div  className='w-full md:w-[70%] mx-auto mt-10 bg-orange-500   p-4 rounded-lg rotate-3 hover:rotate-0 cursor-pointer backdrop-blur shadow-xl   hover:shadow-orange-600 transition-all duration-300'>
          ...
          <div  className='w-full md:w-[70%] mx-auto mt-24 bg-yellow-600 p-4 rounded-lg -rotate-3 hover:rotate-0 cursor-pointer transition-all duration-300 backdrop-blur shadow-xl hover:shadow-yellow-700'>
